...
public abstract class RangeTestBase<
    ...
    public void t04Meets( String as, String bs, String cs, String ds,
        ...
        R range1 = createRange(a, b);
        R range2 = createRange(c, d);
...
//        fail( "hashCodeEquals completed successfully; you know what to do" );
    ...
    void t09OverLap( String rp1, String rp2, String rp3 ) {
        R range1 = createRange(rp1);
        R range2 = createRange(rp2);
        R range3 = createRange(rp3);

        D expected = range3.length();
        D actual = range1.overlap(range2);
    ...
    void t14JoinWith( String pp1, String pp2, String expectedRange ) {
        R range1 = createRange(pp1);
        R range2 = createRange(pp2);
        R range3 = createRange(expectedRange);
